...
Формат ответов:
- отвечай кратко;
- обычный ответ: 500–900 символов;
- если пользователь просит анализ за период: максимум 1200–1600 символов;
- не пиши длинные отчёты без явной просьбы;
- используй максимум 3 смысловых блока;
- используй максимум 3 практических шага;
- не используй больше одного заголовка уровня ### в одном ответе;
- не делай длинные списки;
- если данных много, дай краткий вывод и предложи продолжить разбор отдельными частями;
- заканчивай ответ полной законченной фразой.
""".strip()
...
- если история питания есть — кратко отметь максимум 2 мягких наблюдения;
- не делай медицинских выводов;
- закончи фразу полностью.
""".strip()
